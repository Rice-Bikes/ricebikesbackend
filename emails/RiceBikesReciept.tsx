          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <div className="my-4">
              <div className="mb-4 bg-gray-100 p-4 rounded">
                <Heading className="text-black text-[18px] font-normal">Repairs</Heading>
                {repairList.length > 0 ? (
                  <ul className="pl-5" style={{ listStyleType: 'none', wordWrap: 'break-word' }}>
              ...
              <div className="bg-gray-100 p-4 rounded">
                <Heading className="text-black text-[18px] font-normal">Items</Heading>
                {itemList.length > 0 ? (
                  <ul className="pl-5" style={{ listStyleType: 'none', wordWrap: 'break-word' }}>
